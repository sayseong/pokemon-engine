...
class PokemonPartyBlankPanel < Sprite
  ...
  def initialize(_pokemon, index, viewport = nil)
    ...
    if PARTY_B2W2_STYLE
      @panelbgsprite = AnimatedBitmap.new("Graphics/UI/Party/panel_blank_B2W2")
    else
...
# New Colors (change)
  ...
  def initialize(pokemon, index, viewport = nil)
    ...
    if PARTY_B2W2_STYLE
      if @active   # Rounded panel
        @panelbgsprite.addBitmap("able", "Graphics/UI/Party/panel_round_B2W2")
        @panelbgsprite.addBitmap("ablesel", "Graphics/UI/Party/panel_round_sel_B2W2")
        @panelbgsprite.addBitmap("fainted", "Graphics/UI/Party/panel_round_faint_B2W2")
        @panelbgsprite.addBitmap("faintedsel", "Graphics/UI/Party/panel_round_faint_sel_B2W2")
        @panelbgsprite.addBitmap("swap", "Graphics/UI/Party/panel_round_swap_B2W2")
        @panelbgsprite.addBitmap("swapsel", "Graphics/UI/Party/panel_round_swap_sel_B2W2")
        @panelbgsprite.addBitmap("swapsel2", "Graphics/UI/Party/panel_round_swap_sel2_B2W2")
      else   # Rectangular panel
        @panelbgsprite.addBitmap("able", "Graphics/UI/Party/panel_rect_B2W2")
        @panelbgsprite.addBitmap("ablesel", "Graphics/UI/Party/panel_rect_sel_B2W2")
        @panelbgsprite.addBitmap("fainted", "Graphics/UI/Party/panel_rect_faint_B2W2")
        @panelbgsprite.addBitmap("faintedsel", "Graphics/UI/Party/panel_rect_faint_sel_B2W2")
        @panelbgsprite.addBitmap("swap", "Graphics/UI/Party/panel_rect_swap_B2W2")
        @panelbgsprite.addBitmap("swapsel", "Graphics/UI/Party/panel_rect_swap_sel_B2W2")
        @panelbgsprite.addBitmap("swapsel2", "Graphics/UI/Party/panel_rect_swap_sel2_B2W2")
      end
    else
      if @active   # Rounded panel
    ...
    if PARTY_B2W2_STYLE
      @hpbgsprite.addBitmap("able", "Graphics/UI/Party/overlay_hp_back_B2W2")
      @hpbgsprite.addBitmap("fainted", "Graphics/UI/Party/overlay_hp_back_faint_B2W2")
      @hpbgsprite.addBitmap("swap", "Graphics/UI/Party/overlay_hp_back_swap_B2W2")
    else
  ...
  def draw_level
    ...
    pbDrawImagePositions(@overlaysprite.bitmap,
                         [["Graphics/UI/Party/overlay_lv", 20, 72, 0, 0, 22, 14]])
                       else
    pbDrawImagePositions(@overlaysprite.bitmap,
